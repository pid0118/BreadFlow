...
public interface OrderingMapper {
	public List<OrderingVO> selectOrderingList(List<String> status, String sort, int page, String div, String companyNo); // 전체 발주 조회
	public int selectOrderingPage(List<String> status, String sort, int page, String div, String companyNo); // 발주 현황 전체 페이지 수
	...
	public List<OrderingDetailsVO> selectOrderingDetailList(String orderingCode, String div); // 발주 상세 정보 조회	 
}
